...
int main()
{
    int ft_marks[40] = {83, 86, 97, 95, 93, 95, 86, 52, 49, 41, 42, 47, 90, 59,
                        63, 86, 40, 46, 92, 56, 51, 48, 67, 49, 42, 90, 42, 83, 47, 95, 69, 82,
    ...
    for (i = 0; i < 40; i++)
    {
        total_marks[i] = ceil(ft_marks[i] / 4.0 + st_marks[i] / 4.0 + final_marks[i] / 2.0);
    }
    for (i = 0; i < 40; i++)
    {
